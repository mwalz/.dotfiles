...
# Was formerly using: [[ -s "/usr/local/opt/nvm/nvm.sh" ]] && . "/usr/local/opt/nvm/nvm.sh" # Load NVM function
if [ -s "/usr/local/opt/nvm/nvm.sh" ] && [ ! "$(type -t __init_nvm)" = function ]; then
  ...
  function __init_nvm() {
    ...
    [[ -s "/usr/local/opt/nvm/nvm.sh" ]] && . $(brew --prefix nvm)/nvm.sh # Load NVM function
